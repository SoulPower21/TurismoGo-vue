        ...
        <q-card-section>
          ...
          <q-form @submit="submitForm" ref="form">
            ...
            <q-input
              ...
              dense
              class="input-spacing"
              :rules="[requiredRule('dni'), maxLengthRule('dni', 8)]"
            />
            <q-input
            ...
            <q-input
              ...
              class="input-spacing"
              :rules="[
                requiredRule('contraseña'),
                minLengthRule('contraseña', 6),
              ]"
            />
            <q-input
              ...
              class="input-spacing"
              :rules="[
                requiredRule('repetir contraseña'),
                minLengthRule('repetir contraseña', 6),
                passwordMatchRule,
              ]"
            />
    ...
    maxLengthRule(field, maxLength) {
      return [
        (val) =>
          ...
          `${field} debe tener menos de ${maxLength} caracteres`,
      ];
    },
    minLengthRule(field, minLength) {
      return [
        (val) =>
          ...
          `${field} debe tener al menos ${minLength} caracteres`,
      ];
    },
    passwordMatchRule() {
      return (val) =>
        val === this.formData.password || "Las contraseñas no coinciden";
    },
  },
};
</script>
